...
const TIPS = [
  ...
  "OpenCoder auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "OpenCoder auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "OpenCoder uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent OpenCoder from reading sensitive files",
  "Use {highlight}opencoder run{/highlight} for non-interactive scripting",
  "Use {highlight}opencoder --continue{/highlight} to resume the last session",
  "Use {highlight}opencoder run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opencoder serve{/highlight} for headless API access to OpenCoder",
  "Use {highlight}opencoder run --attach{/highlight} to connect to a running server",
  "Run {highlight}opencoder upgrade{/highlight} to update to the latest version",
  "Run {highlight}opencoder auth list{/highlight} to see all configured providers",
  "Run {highlight}opencoder agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}opencoder github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}opencoder debug config{/highlight} to troubleshoot configuration",
